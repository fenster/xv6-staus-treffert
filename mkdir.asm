...
main(int argc, char *argv[])
{
  ...
  42:	c7 44 24 04 c5 07 00 	movl   $0x7c5,0x4(%esp)
  49:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ba:	f7 f7                	div    %edi
 3bc:	0f b6 92 e8 07 00 00 	movzbl 0x7e8(%edx),%edx
...
putc(int fd, char c)
{
 ...
 630:	e9 30 fe ff ff       	jmp    465 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 635:	bf e1 07 00 00       	mov    $0x7e1,%edi
...
free(void *ap)
{
 ...
 641:	a1 04 08 00 00       	mov    0x804,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 68f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 691:	a3 04 08 00 00       	mov    %eax,0x804
}
 696:	5b                   	pop    %ebx
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 ...
 6b9:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 6bb:	a3 04 08 00 00       	mov    %eax,0x804
}
 6c0:	5b                   	pop    %ebx
 6c1:	5e                   	pop    %esi
 6c2:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 6dc:	8b 0d 04 08 00 00    	mov    0x804,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 704:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 708:	3b 05 04 08 00 00    	cmp    0x804,%eax
 ...
 727:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 72a:	89 0d 04 08 00 00    	mov    %ecx,0x804
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 76c:	e8 cf fe ff ff       	call   640 <free>
  return freep;
 771:	8b 0d 04 08 00 00    	mov    0x804,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 784:	eb a4                	jmp    72a <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 04 08 00 00 fc 	movl   $0x7fc,0x804
 78d:	07 00 00 
    base.s.size = 0;
 790:	b9 fc 07 00 00       	mov    $0x7fc,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 795:	c7 05 fc 07 00 00 fc 	movl   $0x7fc,0x7fc
 79c:	07 00 00 
    base.s.size = 0;
 79f:	c7 05 00 08 00 00 00 	movl   $0x0,0x800
 7a6:	00 00 00 
