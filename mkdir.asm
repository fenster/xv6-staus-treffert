...
main(int argc, char *argv[])
{
  ...
  42:	c7 44 24 04 55 07 00 	movl   $0x755,0x4(%esp)
  49:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	f7 f6                	div    %esi
 3cc:	0f b6 92 78 07 00 00 	movzbl 0x778(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 5ba:	e9 a6 fe ff ff       	jmp    465 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 5bf:	be 71 07 00 00       	mov    $0x771,%esi
...
free(void *ap)
{
 ...
 649:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 64b:	a3 94 07 00 00       	mov    %eax,0x794
}
 650:	5b                   	pop    %ebx
 651:	5e                   	pop    %esi
 652:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 694:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 698:	3b 05 94 07 00 00    	cmp    0x794,%eax
 ...
 6b7:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6ba:	89 0d 94 07 00 00    	mov    %ecx,0x794
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 6fc:	e8 cf fe ff ff       	call   5d0 <free>
  return freep;
 701:	8b 0d 94 07 00 00    	mov    0x794,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 714:	eb a4                	jmp    6ba <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 94 07 00 00 8c 	movl   $0x78c,0x794
 71d:	07 00 00 
    base.s.size = 0;
 720:	b9 8c 07 00 00       	mov    $0x78c,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 725:	c7 05 8c 07 00 00 8c 	movl   $0x78c,0x78c
 72c:	07 00 00 
    base.s.size = 0;
 72f:	c7 05 90 07 00 00 00 	movl   $0x0,0x790
 736:	00 00 00 
