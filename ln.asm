...
main(int argc, char *argv[])
{
  ...
  13:	c7 44 24 04 4e 07 00 	movl   $0x74e,0x4(%esp)
  1a:	00 
  ...
  5a:	c7 44 24 04 61 07 00 	movl   $0x761,0x4(%esp)
  61:	00 
...
printf(int fd, char *fmt, ...)
{
 ...
 5ca:	e9 a6 fe ff ff       	jmp    475 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 5cf:	be 75 07 00 00       	mov    $0x775,%esi
...
free(void *ap)
{
 ...
 5e1:	a1 98 07 00 00       	mov    0x798,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 62f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 631:	a3 98 07 00 00       	mov    %eax,0x798
}
 636:	5b                   	pop    %ebx
 637:	5e                   	pop    %esi
 638:	5f                   	pop    %edi
 ...
 659:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 65b:	a3 98 07 00 00       	mov    %eax,0x798
}
 660:	5b                   	pop    %ebx
 661:	5e                   	pop    %esi
 662:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 679:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 67c:	8b 0d 98 07 00 00    	mov    0x798,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6a8:	3b 05 98 07 00 00    	cmp    0x798,%eax
 ...
 6c7:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6ca:	89 0d 98 07 00 00    	mov    %ecx,0x798
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 70c:	e8 cf fe ff ff       	call   5e0 <free>
  return freep;
 711:	8b 0d 98 07 00 00    	mov    0x798,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 724:	eb a4                	jmp    6ca <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 98 07 00 00 90 	movl   $0x790,0x798
 72d:	07 00 00 
    base.s.size = 0;
 730:	b9 90 07 00 00       	mov    $0x790,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 735:	c7 05 90 07 00 00 90 	movl   $0x790,0x790
 73c:	07 00 00 
    base.s.size = 0;
 73f:	c7 05 94 07 00 00 00 	movl   $0x0,0x794
 746:	00 00 00 
