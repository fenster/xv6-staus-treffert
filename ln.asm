...
main(int argc, char *argv[])
{
  ...
  13:	c7 44 24 04 5e 07 00 	movl   $0x75e,0x4(%esp)
  1a:	00 
  ...
  5a:	c7 44 24 04 71 07 00 	movl   $0x771,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ea:	f7 f6                	div    %esi
 3ec:	0f b6 92 8c 07 00 00 	movzbl 0x78c(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 5da:	e9 a6 fe ff ff       	jmp    485 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 5df:	be 85 07 00 00       	mov    $0x785,%esi
...
free(void *ap)
{
 ...
 5f1:	a1 a8 07 00 00       	mov    0x7a8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 63f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 641:	a3 a8 07 00 00       	mov    %eax,0x7a8
}
 646:	5b                   	pop    %ebx
 647:	5e                   	pop    %esi
 648:	5f                   	pop    %edi
 ...
 669:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 66b:	a3 a8 07 00 00       	mov    %eax,0x7a8
}
 670:	5b                   	pop    %ebx
 671:	5e                   	pop    %esi
 672:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 689:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 68c:	8b 0d a8 07 00 00    	mov    0x7a8,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6b8:	3b 05 a8 07 00 00    	cmp    0x7a8,%eax
 ...
 6d7:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6da:	89 0d a8 07 00 00    	mov    %ecx,0x7a8
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 71c:	e8 cf fe ff ff       	call   5f0 <free>
  return freep;
 721:	8b 0d a8 07 00 00    	mov    0x7a8,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 734:	eb a4                	jmp    6da <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 a8 07 00 00 a0 	movl   $0x7a0,0x7a8
 73d:	07 00 00 
    base.s.size = 0;
 740:	b9 a0 07 00 00       	mov    $0x7a0,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 745:	c7 05 a0 07 00 00 a0 	movl   $0x7a0,0x7a0
 74c:	07 00 00 
    base.s.size = 0;
 74f:	c7 05 a4 07 00 00 00 	movl   $0x0,0x7a4
 756:	00 00 00 
