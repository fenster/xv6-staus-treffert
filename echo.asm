...
main(int argc, char *argv[])
{
  ...
  28:	c7 44 24 0c 5e 07 00 	movl   $0x75e,0xc(%esp)
  2f:	00 
  30:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  34:	83 c3 01             	add    $0x1,%ebx
  37:	c7 44 24 04 60 07 00 	movl   $0x760,0x4(%esp)
  3e:	00 
  ...
  53:	c7 44 24 0c 65 07 00 	movl   $0x765,0xc(%esp)
  5a:	00 
  5b:	8b 44 b7 fc          	mov    -0x4(%edi,%esi,4),%eax
  5f:	c7 44 24 04 60 07 00 	movl   $0x760,0x4(%esp)
  66:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ea:	f7 f6                	div    %esi
 3ec:	0f b6 92 6e 07 00 00 	movzbl 0x76e(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 5da:	e9 a6 fe ff ff       	jmp    485 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 5df:	be 67 07 00 00       	mov    $0x767,%esi
...
free(void *ap)
{
 ...
 5f1:	a1 88 07 00 00       	mov    0x788,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 63f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 641:	a3 88 07 00 00       	mov    %eax,0x788
}
 646:	5b                   	pop    %ebx
 647:	5e                   	pop    %esi
 648:	5f                   	pop    %edi
 ...
 669:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 66b:	a3 88 07 00 00       	mov    %eax,0x788
}
 670:	5b                   	pop    %ebx
 671:	5e                   	pop    %esi
 672:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 689:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 68c:	8b 0d 88 07 00 00    	mov    0x788,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6b8:	3b 05 88 07 00 00    	cmp    0x788,%eax
 ...
 6d7:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6da:	89 0d 88 07 00 00    	mov    %ecx,0x788
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 71c:	e8 cf fe ff ff       	call   5f0 <free>
  return freep;
 721:	8b 0d 88 07 00 00    	mov    0x788,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 734:	eb a4                	jmp    6da <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 88 07 00 00 80 	movl   $0x780,0x788
 73d:	07 00 00 
    base.s.size = 0;
 740:	b9 80 07 00 00       	mov    $0x780,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 745:	c7 05 80 07 00 00 80 	movl   $0x780,0x780
 74c:	07 00 00 
    base.s.size = 0;
 74f:	c7 05 84 07 00 00 00 	movl   $0x0,0x784
 756:	00 00 00 
