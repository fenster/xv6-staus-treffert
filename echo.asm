...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	f7 f6                	div    %esi
 3dc:	0f b6 92 5e 07 00 00 	movzbl 0x75e(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 5ca:	e9 a6 fe ff ff       	jmp    475 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 5cf:	be 57 07 00 00       	mov    $0x757,%esi
...
free(void *ap)
{
 ...
 5e1:	a1 78 07 00 00       	mov    0x778,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 62f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 631:	a3 78 07 00 00       	mov    %eax,0x778
}
 636:	5b                   	pop    %ebx
 637:	5e                   	pop    %esi
 638:	5f                   	pop    %edi
 ...
 659:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 65b:	a3 78 07 00 00       	mov    %eax,0x778
}
 660:	5b                   	pop    %ebx
 661:	5e                   	pop    %esi
 662:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 679:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 67c:	8b 0d 78 07 00 00    	mov    0x778,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6a8:	3b 05 78 07 00 00    	cmp    0x778,%eax
 ...
 6c7:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6ca:	89 0d 78 07 00 00    	mov    %ecx,0x778
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 70c:	e8 cf fe ff ff       	call   5e0 <free>
  return freep;
 711:	8b 0d 78 07 00 00    	mov    0x778,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 724:	eb a4                	jmp    6ca <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 78 07 00 00 70 	movl   $0x770,0x778
 72d:	07 00 00 
    base.s.size = 0;
 730:	b9 70 07 00 00       	mov    $0x770,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 735:	c7 05 70 07 00 00 70 	movl   $0x770,0x770
 73c:	07 00 00 
    base.s.size = 0;
 73f:	c7 05 74 07 00 00 00 	movl   $0x0,0x774
 746:	00 00 00 
